...
def main():
    ...
    parser.add_argument('--seq_length', type=int, default=240,
    ...
    parser.add_argument('--freq_validation', type=int, default=100,
                        help='Frequency number(epoch) of validation using validation data')
    
    # frequency of optimazer learning decay
    parser.add_argument('--freq_optimizer', type=int, default=10,
